...
class CarController
{
    ...
    public static function getAllCars()
    {
        ...
        foreach ($result as $car) {
            ...
            $cars[] = new Car($car['brand'], $car['model'], $car['kilometrage'], $car['description'], $car['vitesse'], $car['year'], $car['image'], $car['idOwner'], $car['prix'], $car['ville'], $car['disponibilite'], $car['id']);
        }
        return $cars;
    }
    ...
    public static function getCarById($id)
    {
        ...
        return new Car( $result[0]['brand'], $result[0]['model'], $result[0]['kilometrage'], $result[0]['description'], $result[0]['vitesse'], $result[0]['year'], $result[0]['image'], $result[0]['idOwner'], $result[0]['prix'], $result[0]['ville'], $result[0]['disponibilite'], $result[0]['id']);
    }

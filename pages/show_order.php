                    ...
                    <div class="col-md-5">
                        <div class="card-body text-end">
                            <div class="card-content mb-3">
                                ...
                                <?php if ($payment->getPaymentReceipt() == null): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <form action="route('pdf_user')" method="post">
                                        <button class="btn btn-success" type="submit">Télécharger la preuve de paiement</button>
                                    </form>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>

                            <?php if ($payment_receipt == null): ?>
                                        ...
                                        <div class="modal-body text-start">
                                            <div class="mb-3">
                                                <div class="input-group mb-3">
                                                    <label class="input-group-text" for="inputGroupSelect01"><i class="fa fa-credit-card" aria-hidden="true"></i></label>
                                                    <select class="form-select" id="inputGroupSelect01">
                                                        <option selected>Mode de paiement...</option>
                                                        <option value="1">LCL - 123456789000</option>
                                                        <option value="2">BNP - 000987654321</option>
                                                        <option value="3">SG - 5678900001234</option>
                                                    </select>
                                                </div>

                                                <label for="formFileMultiple" class="form-label">Veuillez saisir la preuve de paiement</label>
                                                <form action="route('submit_payment_receipt', $order)" method="post" enctype="multipart/form-data">
                                                    <input class="form-control" placeholder="Preuves en entrée" type="file" id="formFileMultiple" multiple name="payment_receipt">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                                            <button class="btn btn-primary" type="submit">Soumettre <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-upload mb-1" viewBox="0 0 16 16">
